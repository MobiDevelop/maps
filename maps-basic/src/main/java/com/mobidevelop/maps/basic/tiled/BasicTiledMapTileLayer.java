...
public class BasicTiledMapTileLayer implements TiledMapTileLayer {
	...
	public BasicTiledMapTileLayer(Map map, float tileWidth, float tileHeight) {
		this(map, tileWidth, tileHeight, 0, 0);
	}

	public BasicTiledMapTileLayer(Map map, float tileWidth, float tileHeight, int widthInTiles, int heightInTiles) {
		this(map, 0, 0, tileWidth, tileHeight, widthInTiles, heightInTiles);
	}

	public BasicTiledMapTileLayer(Map map, float x, float y, float tileWidth, float tileHeight, int widthInTiles, int heightInTiles) {
		this.map = map;
		this.x = x;
		this.y = y;		
		this.tileWidth = tileWidth;
